        ...
        <ul className="nav flex-column sidebar-menu small fw-medium">
          ...
          <li>
            <NavLink className="nav-link" to="/events">
              <i className="fas fa-users"></i> <span>Events</span>
            </NavLink>
          </li>
          {/* Sales Dropdown */}
          ...
          <li className="nav-item">
            ...
            >
              <i className="bi bi-file-earmark-text-fill mx-2"></i>Leave
              Applications
            </NavLink>
          </li>
          <li className="nav-item">
          ...
          {/* Section Header */}
          <li className="nav-item text-uppercase text-muted mt-3 mb-1 small">
            Settings
          </li>

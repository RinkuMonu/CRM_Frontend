...
const CountsCard = ({ title, count }) => {
  ...
  const { icon, bgColor, borderColor, trendColor, href, iconColor, bgPattern } = getStylesByTitle(title);
        ...
        <div className="card-body  position-relative z-index-1">
          ...
          <div className="d-flex align-items-start mb-1">
            ...
            <div className="ms-3 flex-grow-1">
              ...
              <h5 className="fw-bold text-dark mt-1 mb-0 display-">
                {count}
              </h5>
            </div>
          </div>
          ...
          <div className="d-flex justify-content-between align-items-center border-top border-light">
            ...
            >
              Details
              <i className="fas fa-chevron-right ms-2" style={{ fontSize: "0.7rem" }}></i>
            </Link>
          </div>
        </div>
      </div>
